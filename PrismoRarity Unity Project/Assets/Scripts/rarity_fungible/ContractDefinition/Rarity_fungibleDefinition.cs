...
namespace Scripts.Contracts.rarity_fungible.ContractDefinition
{


    public partial class Rarity_fungibleDeployment : Rarity_fungibleDeploymentBase
    {
        public Rarity_fungibleDeployment() : base(BYTECODE) { }
        public Rarity_fungibleDeployment(string byteCode) : base(byteCode) { }
    }

    public class Rarity_fungibleDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public Rarity_fungibleDeploymentBase() : base(BYTECODE) { }
        public Rarity_fungibleDeploymentBase(string byteCode) : base(byteCode) { }
