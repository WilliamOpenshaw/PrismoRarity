...
using Scripts.Contracts.rarity_item1.ContractDefinition;

namespace Scripts.Contracts.rarity_item1
{
    public partial class Rarity_item1Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, Rarity_item1Deployment rarity_item1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<Rarity_item1Deployment>().SendRequestAndWaitForReceiptAsync(rarity_item1Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, Rarity_item1Deployment rarity_item1Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<Rarity_item1Deployment>().SendRequestAsync(rarity_item1Deployment);
        }

        public static async Task<Rarity_item1Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, Rarity_item1Deployment rarity_item1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, rarity_item1Deployment, cancellationTokenSource);
            return new Rarity_item1Service(web3, receipt.ContractAddress);
        }
        ...
        public Rarity_item1Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
