...
namespace Scripts.Contracts.rarity_item1.ContractDefinition
{


    public partial class Rarity_item1Deployment : Rarity_item1DeploymentBase
    {
        public Rarity_item1Deployment() : base(BYTECODE) { }
        public Rarity_item1Deployment(string byteCode) : base(byteCode) { }
    }

    public class Rarity_item1DeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public Rarity_item1DeploymentBase() : base(BYTECODE) { }
        public Rarity_item1DeploymentBase(string byteCode) : base(byteCode) { }
