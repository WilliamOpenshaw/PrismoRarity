...
namespace Scripts.Contracts.rarity_names.ContractDefinition
{


    public partial class Rarity_namesDeployment : Rarity_namesDeploymentBase
    {
        public Rarity_namesDeployment() : base(BYTECODE) { }
        public Rarity_namesDeployment(string byteCode) : base(byteCode) { }
    }

    public class Rarity_namesDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public Rarity_namesDeploymentBase() : base(BYTECODE) { }
        public Rarity_namesDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class Summoner_nameFunction : Summoner_nameFunctionBase { }

    [Function("summoner_name", "string")]
    public class Summoner_nameFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "", 1)]
    ...
    public partial class Summoner_nameOutputDTO : Summoner_nameOutputDTOBase { }

    [FunctionOutput]
    public class Summoner_nameOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("string", "", 1)]
