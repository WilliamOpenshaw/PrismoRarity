...
using Scripts.Contracts.rarity_gold.ContractDefinition;

namespace Scripts.Contracts.rarity_gold
{
    public partial class Rarity_goldService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, Rarity_goldDeployment rarity_goldDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<Rarity_goldDeployment>().SendRequestAndWaitForReceiptAsync(rarity_goldDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, Rarity_goldDeployment rarity_goldDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<Rarity_goldDeployment>().SendRequestAsync(rarity_goldDeployment);
        }

        public static async Task<Rarity_goldService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, Rarity_goldDeployment rarity_goldDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, rarity_goldDeployment, cancellationTokenSource);
            return new Rarity_goldService(web3, receipt.ContractAddress);
        }
        ...
        public Rarity_goldService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<BigInteger> ClaimedQueryAsync(BigInteger summoner, BlockParameter blockParameter = null)
        {
            var claimedFunction = new ClaimedFunction();
                claimedFunction.Summoner = summoner;
